...
void leitura_sinais()
{
  ...
  Serial.print("Ax: "); Serial.print(FreqX);

  //  Serial.print("FODAFrequentia: "); Serial.print(Freq);

  Serial.print(" Ay: "); Serial.print(FreqY);

  Serial.print(" Az: "); Serial.print(FreqZ);
...
void converte_json()
{
  StaticJsonDocument<300> sjson_freqX;
  StaticJsonDocument<300> sjson_freqY;
  StaticJsonDocument<300> sjson_freqZ;
  ...
  sjson_freqX["variable"] = "freqX";
  sjson_freqX["value"] = FreqX;
  serializeJson(sjson_freqX, json_freqX);
  
  sjson_freqY["variable"] = "freqY";
  sjson_freqY["value"] = FreqY;
  serializeJson(sjson_freqY, json_freqY);
  
  
  sjson_freqZ["variable"] = "freqZ";
  sjson_freqZ["value"] = FreqZ;
  serializeJson(sjson_freqZ, json_freqZ);
...
void envia_msg()
{
  client.publish("node/acelerometro", json_freqX);
  client.publish("node/acelerometro", json_freqY);
  client.publish("node/acelerometro", json_freqZ);
